  ...
  return (
    <div className="mt-20 flex flex-col sm:flex-row items-center justify-center gap-8 p-6 sm:p-10 bg-gradient-to-br from-[#374151] to-purple-600">
      ...
      {desc.map((item, index) => (
        <motion.div
          key={index}
          className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl bg-gradient-to-r from-[#374151] to-purple-800 rounded-2xl shadow-lg text-white p-6 text-sm sm:text-lg font-semibold leading-relaxed"
