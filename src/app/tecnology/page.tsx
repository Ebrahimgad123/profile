...
const technologies = [
  ...
  { name: "Next.js", image: "https://upload.wikimedia.org/wikipedia/commons/8/8e/Nextjs-logo.svg" }, // تمت إضافته هنا ✅
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Discover various full-stack technologies including MongoDB, Express.js, React.js, Next.js, and more!" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          {technologies.map((tech, index) => (
            ...
            >
              ...
              <img src={tech.image} alt={tech.name} style={{ objectFit: "contain" }} />
              </div>
